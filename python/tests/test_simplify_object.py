...
expected_simple_object = {'issue_id': '10022', 'issue_key': 'MPPSAM-23', 'issue_type': 'Story', 'timespent': None, 'project': 'mpp-sample', 'priority': 'Medium', 'assignee_name': 'rsegrest77@gmail.com', 'status_name': 'Done', 'created': '2023-06-03T06:19:25.000+0000', 'resolution_date': '2023-06-15T14:54:25.000+0000', 'development': '{summaryBean=com.atlassian.jira.plugin.devstatus.rest.SummaryBean@337f5620[summary={pullrequest=com.atlassian.jira.plugin.devstatus.rest.SummaryItemBean@39fcfe05[overall=PullRequestOverallBean{stateCount=0, state=\'OPEN\', details=PullRequestOverallDetails{openCount=0, mergedCount=0, declinedCount=0}},byInstanceType={}], build=com.atlassian.jira.plugin.devstatus.rest.SummaryItemBean@11031f1f[overall=com.atlassian.jira.plugin.devstatus.summary.beans.BuildOverallBean@4f51c7ec[failedBuildCount=0,successfulBuildCount=0,unknownBuildCount=0,count=0,lastUpdated=<null>,lastUpdatedTimestamp=<null>],byInstanceType={}], review=com.atlassian.jira.plugin.devstatus.rest.SummaryItemBean@621b7ee3[overall=com.atlassian.jira.plugin.devstatus.summary.beans.ReviewsOverallBean@1e80c19d[stateCount=0,state=<null>,dueDate=<null>,overDue=false,count=0,lastUpdated=<null>,lastUpdatedTimestamp=<null>],byInstanceType={}], deployment-environment=com.atlassian.jira.plugin.devstatus.rest.SummaryItemBean@1772ceb5[overall=com.atlassian.jira.plugin.devstatus.summary.beans.DeploymentOverallBean@56dd1510[topEnvironments=[],showProjects=false,successfulCount=0,count=0,lastUpdated=<null>,lastUpdatedTimestamp=<null>],byInstanceType={}], repository=com.atlassian.jira.plugin.devstatus.rest.SummaryItemBean@6f08954e[overall=com.atlassian.jira.plugin.devstatus.summary.beans.CommitOverallBean@771c3d1b[count=0,lastUpdated=<null>,lastUpdatedTimestamp=<null>],byInstanceType={}], branch=com.atlassian.jira.plugin.devstatus.rest.SummaryItemBean@761a422b[overall=com.atlassian.jira.plugin.devstatus.summary.beans.BranchOverallBean@48d1bc6d[count=0,lastUpdated=<null>,lastUpdatedTimestamp=<null>],byInstanceType={}]},errors=[],configErrors=[]], devSummaryJson={"cachedValue":{"errors":[],"configErrors":[],"summary":{"pullrequest":{"overall":{"count":0,"lastUpdated":null,"stateCount":0,"state":"OPEN","details":{"openCount":0,"mergedCount":0,"declinedCount":0,"total":0},"open":true},"byInstanceType":{}},"build":{"overall":{"count":0,"lastUpdated":null,"failedBuildCount":0,"successfulBuildCount":0,"unknownBuildCount":0},"byInstanceType":{}},"review":{"overall":{"count":0,"lastUpdated":null,"stateCount":0,"state":null,"dueDate":null,"overDue":false,"completed":false},"byInstanceType":{}},"deployment-environment":{"overall":{"count":0,"lastUpdated":null,"topEnvironments":[],"showProjects":false,"successfulCount":0},"byInstanceType":{}},"repository":{"overall":{"count":0,"lastUpdated":null},"byInstanceType":{}},"branch":{"overall":{"count":0,"lastUpdated":null},"byInstanceType":{}}}},"isStale":false}}', 'story_points': 2.0}
expected_custom_fields = [{'id': 'customfield_10000', 'name': 'Development'},{'id': 'customfield_10106', 'name': 'Epic Colour'},{'id': 'customfield_10109', 'name': 'Epic Link'},{'id': 'customfield_10104', 'name': 'Epic Name'},{'id': 'customfield_10105', 'name': 'Epic Status'},{'id': 'customfield_10103', 'name': 'Original story points'},{'id': 'customfield_10100', 'name': 'Parent Link'},{'id': 'customfield_10108', 'name': 'Rank'},{'id': 'customfield_10110', 'name': 'Sprint'},{'id': 'customfield_10111', 'name': 'Story Points'},{'id': 'customfield_10102', 'name': 'Target end'},{'id': 'customfield_10101', 'name': 'Target start'},{'id': 'customfield_10107', 'name': 'Team'}]
expected_default_fields = ['Development','Epic Colour','Epic Link','Epic Name','Epic Status','Original story points','Parent Link','Rank','Sprint','Story Points','Target end','Target start','Team']
expected_renamed_fields = ['development','epic_color','epic_link','epic_name','epic_status','original_story_points','parent_link','rank','sprint','story_points','target_end','target_start','team',]

def test_simplify_object():
    assert simplify_object(response) == expected_simple_object

def test_get_custom_fields():
    assert get_custom_fields() == expected_custom_fields

def test_rename_custom_fields():
    fields = list(map(lambda field: field['name'], expected_custom_fields))
    assert fields == expected_default_fields

    renamed_fields = []
    for field in fields:
        assert type(field) == str
        renamed_fields.append(rename_custom_field(field))
    assert renamed_fields == expected_renamed_fields
